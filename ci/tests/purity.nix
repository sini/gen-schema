...
let
  ...
  # by whitespace. A `#` flush against other text is inside a string literal (`lib/docs.nix` emits
  # markdown headings that way), and cutting there hides every character after it — code included
